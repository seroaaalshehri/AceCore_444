...
// --- Rocket League skills (stars 1–5) ---
...
export default function ClubEvaluateRLPage() {
  ...
  async function handleSaveEvaluation() {
    ...
    try {
      ...
      console.log("Saved Rocket League evaluation for:", evaluationModal.requestId, currentEval);
  ...
  // Top "Save" button for whole page (opens confirmation)
  ...
  async function confirmSavePage() {
    ...
    // hook for future: final save for all evaluations
    console.log("All Rocket League evaluations:", gamerEvaluations);
  }
  ...
  <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
    ...
    >
      ...
      <h3 className="text-3xl font-bold mb-3 text-center text-[#FCCC22]">
        Evaluate {evaluationModal.gamer.firstName} {evaluationModal.gamer.lastName}
      </h3>
            ...
            <div key={field} className="mb-2">
              ...
              <input
                ...
                className={`w-full bg-[#0C0817] rounded px-3 py-2 text-base 
                  focus:outline-none focus:ring-2 focus:ring-[#FCCC22]/60 border ${
                    fieldErrors[field] ? "border-red-500" : "border-[#3b2d5e]"
                  }`}
...
>
  {evaluationModal.loading ? "Saving..." : "Save"}
      ...
      {showSaveConfirm && (
        <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50">
          <div className="bg-[#1C1633] font-barlow text-white p-6 rounded-xl shadow-2xl w-[350px] text-center">
            <p className="text-2xl font-bold mb-4">
              Are you sure you want to save your evaluations?
            </p>
            <div className="flex w-full space-x-2">
              <button
                onClick={confirmSavePage}
                className="w-1/2 bg-[#4682B4] hover:neon-btn-blue px-3 py-1 rounded text-xl font-bold"
              >
                Yes
              </button>
              <button
                onClick={() => setShowSaveConfirm(false)}
                className="w-1/2 bg-gray-500 hover:neon-btn-gray px-4 py-2 rounded text-xl font-bold"
              >
                No
              </button>
            </div>
          ...
          <div className="bg-[#1C1633] text-white p-6 font-barlow rounded-xl shadow-2xl w-[350px] text-center">
            ...
            <div className="flex w-full space-x-2">
              <button
                ...
                className="w-1/2 bg-red-500 hover:neon-btn-red px-4 py-2 rounded text-xl font-bold"
              >
                Yes
              </button>
              <button
